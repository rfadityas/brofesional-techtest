...
export default function Home() {
    ...
    const usersFiltered = useSelector((state: RootState) => filterUsers(state, query))
                        ...
                        <tbody>
                            ...
                            {usersFiltered?.map((user, index) => (
                                <tr key={user.id} className='border-b border-gray-200 hover:bg-gray-100'>
                                    ...
                                    <td className="p-3  text-sm lg:text-lg">{user.company.name}</td>
                                    <td className="p-3 flex gap-2">
                                        ...
                                        <button onClick={handleDelete(user.id)} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 lg:py-2 lg:px-4 rounded">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
